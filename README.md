...
```javascript
asecf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-asecf@v0.1.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-asecf@v0.1.2-umd/browser.js"></script>
```
